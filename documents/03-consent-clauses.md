...
### A. Newsletter / marketing opt-in

Use near the email signup field. **Checkbox must be unticked by default.**

> ☐ I would like to receive [Business Name]'s newsletter with news, offers,
> and updates by email. You can unsubscribe at any time using the link in
> every email. See our [Privacy Policy] for how we handle your data. We will
...
Use directly under a "Send" / "Submit" button on a contact form.

> By submitting this form, you agree that [Business Name] will use the
> information provided (name, email, message) to respond to your enquiry, as
> described in our [Privacy Policy]. We will not use this information for
...
### C. Account creation at checkout

Use near the "Create account" / "Register" button.
...
> By submitting a comment, your name and comment text will be published on
> this page. Your email address will not be published. See our [Privacy
> Policy] for details.

---

**Disclaimer:** These clauses are templates provided for general informational
purposes only and do not constitute legal advice. They must be reviewed and
...
operator accept no liability for outcomes arising from use of these
templates.
...
### A. Iscrizione a newsletter / marketing

Da usare vicino al campo di iscrizione email. **La casella deve essere
deselezionata di default.**

> ☐ Desidero ricevere la newsletter di [Nome Attività] con novità, offerte e
> aggiornamenti via email. Puoi disiscriverti in qualsiasi momento tramite il
> link presente in ogni email. Consulta la nostra [Informativa Privacy] per
> sapere come trattiamo i tuoi dati. Non condivideremo la tua email con terzi
...
Da usare direttamente sotto il pulsante "Invia" di un modulo di contatto.

> Inviando questo modulo, accetti che [Nome Attività] utilizzi le
> informazioni fornite (nome, email, messaggio) per rispondere alla tua
> richiesta, come descritto nella nostra [Informativa Privacy]. Non
> utilizzeremo queste informazioni per finalità di marketing salvo tua
> adesione separata.
...
### C. Creazione account al checkout

Da usare vicino al pulsante "Crea account" / "Registrati".
...
> Inviando un commento, il tuo nome e il testo del commento saranno
> pubblicati in questa pagina. Il tuo indirizzo email non sarà pubblicato.
> Consulta la nostra [Informativa Privacy] per i dettagli.

---

**Disclaimer:** Queste clausole sono modelli forniti a scopo puramente
informativo e non costituiscono consulenza legale. Devono essere riviste e
adattate alla specifica attività dell'acquirente e, ove opportuno, verificate
