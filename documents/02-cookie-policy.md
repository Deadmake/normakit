...
They are widely used to make websites work, work more efficiently, and
provide information to the site owner.

### 2. How we use cookies

We use cookies for the categories described below. [Business Name] does not
use cookies to determine your identity beyond what's needed for the purposes
listed.
...
- The banner must appear on first visit, before any non-necessary cookie is
  set.
...
**Suggested banner copy (EN):**

> We use cookies to run this site (always on) and, with your permission, to
> understand how it's used and remember your preferences. You can change your
> choice anytime via "Cookie settings" in the footer.
> [Reject all] [Customize] [Accept all]

### 5. How to manage/withdraw consent

You can withdraw or change your cookie consent at any time via the "Cookie
settings" link in our website footer, or by adjusting your browser settings
to block or delete cookies (note: blocking necessary cookies may break site
functionality).
...
I cookie sono piccoli file di testo salvati sul tuo dispositivo quando visiti
un sito web. Sono ampiamente usati per far funzionare i siti, farli funzionare
in modo più efficiente e fornire informazioni al gestore del sito.

### 2. Come usiamo i cookie

Utilizziamo cookie per le categorie descritte di seguito. [Nome Attività] non
usa cookie per determinare la tua identità oltre a quanto necessario per le
finalità elencate.
...
- Il banner deve comparire alla prima visita, prima che venga impostato
  qualsiasi cookie non necessario.
...
- Il consenso deve essere registrato (data/ora + scelta) nel caso sia
  necessario dimostrare la conformità in futuro.

**Testo banner suggerito (IT):**

> Utilizziamo cookie per far funzionare questo sito (sempre attivi) e, con il
> tuo consenso, per capire come viene utilizzato e ricordare le tue
> preferenze. Puoi modificare la tua scelta in qualsiasi momento tramite
> "Impostazioni cookie" nel footer.
> [Rifiuta tutto] [Personalizza] [Accetta tutto]

### 5. Come gestire/revocare il consenso

Puoi revocare o modificare il tuo consenso ai cookie in qualsiasi momento
tramite il link "Impostazioni cookie" nel footer del nostro sito, oppure
modificando le impostazioni del browser per bloccare o eliminare i cookie
(nota: bloccare i cookie necessari potrebbe compromettere il funzionamento del
sito).
...
Per come trattiamo i dati personali in generale, vedi la nostra [Informativa
Privacy]. Domande: [email].
