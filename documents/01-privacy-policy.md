...
[Legal name of sole trader / company, if different]
[Registered address]
...
We do not collect special categories of data (health, religion, political
opinions, etc.) unless explicitly stated elsewhere on our site.

### 3. Where your data comes from

Directly from you (forms you fill in, purchases you make, emails you send us),
and automatically via cookies/analytics when you browse our site (see our
[Cookie Policy]).
...
[If all processors are EU-based: "All the processors listed above store data
within the European Economic Area (EEA)."]

[If any processor is outside the EEA, e.g. US-based tools: "Some of our
processors (for example, [Processor Name]) are located outside the EEA. Where
this happens, we rely on the European Commission's Standard Contractual
Clauses (SCCs) or an adequacy decision to ensure your data receives an
equivalent level of protection. You can request a copy of the relevant
safeguard by contacting us at [email]."]
...
To exercise any of these rights, contact us at [privacy email]. We will
respond within one month (extendable by two further months for complex
requests, per Art. 12(3)).
...
[Default: "We do not use automated decision-making or profiling that produces
legal or similarly significant effects on you." Replace if you do use
automated scoring/profiling and describe the logic, significance, and
consequences per Art. 13(2)(f) / Art. 22.]

### 10. Changes to this policy

We may update this policy from time to time. The "Last updated" date at the
top will reflect the most recent revision. Material changes will be
communicated via [email / a notice on the site].

### 11. Contact

Questions about this policy or your data: [email], [postal address].
...
[Denominazione legale, se diversa]
[Sede legale]
[Partita IVA]
...
questa riga se ne nomini uno e aggiungi i suoi contatti.]
...
Non raccogliamo categorie particolari di dati (salute, opinioni religiose o
politiche, ecc.) salvo diversa indicazione esplicita sul sito.

### 3. Da dove provengono i tuoi dati

Direttamente da te (moduli compilati, acquisti effettuati, email inviateci) e
automaticamente tramite cookie/strumenti di analisi durante la navigazione
...
[Se tutti i fornitori sono nell'UE: "Tutti i fornitori sopra elencati
conservano i dati all'interno dello Spazio Economico Europeo (SEE)."]

[Se un fornitore è extra-SEE, es. strumenti USA: "Alcuni dei nostri fornitori
(ad esempio [Nome Fornitore]) si trovano al di fuori del SEE. In questi casi ci
basiamo sulle Clausole Contrattuali Standard (SCC) della Commissione Europea o
su una decisione di adeguatezza per garantire un livello di protezione
equivalente. Puoi richiedere una copia della relativa garanzia scrivendo a
[email]."]
...
Per esercitare uno di questi diritti, contattaci a [email privacy].
Risponderemo entro un mese (prorogabile di due mesi per richieste complesse,
...
[Default: "Non utilizziamo processi decisionali automatizzati o di profilazione
che producano effetti giuridici o similmente significativi nei tuoi
confronti." Sostituisci se utilizzi scoring/profilazione automatizzati e
descrivi la logica, la rilevanza e le conseguenze ai sensi dell'Art. 13(2)(f) /
Art. 22.]

### 10. Modifiche alla presente informativa

Potremmo aggiornare periodicamente questa informativa. La data "Ultimo
aggiornamento" in cima rifletterà la revisione più recente. Le modifiche
sostanziali saranno comunicate tramite [email / avviso sul sito].

### 11. Contatti

Domande su questa informativa o sui tuoi dati: [email], [indirizzo postale].
