...
€10 to 15 test and the €100 total cap. Not executing spend yet, that's P3, and
...
No fixed minimum spend (self-set daily budget, e.g. €12 to 15/day), self-serve
...
€10 to 15 bet when Bing tests the same intent type with less expected friction.
